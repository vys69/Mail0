...
const Webhooks = () => {
  ...
  return (
    <motion.div
      ...
      className="flex h-full min-h-[6rem] w-full flex-1 p-4 bg-dot-black/[0.2] dark:bg-dot-white/[0.2]"
    >
...
const CLI = () => {
  ...
  return (
    <motion.div
      initial="initial"
      whileHover="hover"
      className="flex h-full min-h-[6rem] w-full flex-1 p-2 bg-dot-black/[0.2] dark:bg-dot-white/[0.2]"
    >
